...
const Whilefunction2 = fnCondition => (fnProcess, arg) =>
  arg === undefined
    ? Whilefunction(fnCondition)(fnProcess)
    : Whilefunction(fnCondition)(fnProcess)(arg);
/**
...
const invokeWhile = function(fnCondition, fnProcess, arg) {
  if (arguments.length === 1) return Whilefunction(fnCondition);
  else if (arguments.length === 2) return Whilefunction(fnCondition)(fnProcess);
